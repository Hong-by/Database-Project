      ...
      <div class="center">
        ...
        <div class="write comm_center">
          ...
          <form class="write_form"
            action="/zay/php/community_update.php?detail_idx=<?=$detail_idx?>&deail_writer=<?=$detail_id?>"
          ...
          <div class="write_btn">
            ...
            <a href="/zay/php/community_delete.php?detail_idx=<?=$detail_idx?>&deail_writer=<?=$detail_id?>">삭제하기</a>
            <?php } ?>
          </div>
        </div>
        <!-- End of write -->
